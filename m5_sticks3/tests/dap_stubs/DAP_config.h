...
static inline void probe_delay_cycles(uint32_t cycles) { (void)cycles; }
...
#define TIMESTAMP_GET() fake_timestamp()
#define PIN_SWCLK_TCK_SET() fake_clock(1)
#define PIN_SWCLK_TCK_CLR() fake_clock(0)
#define PIN_SWCLK_TCK_IN() 1U
#define PIN_SWDIO_TMS_SET() fake_output(1)
#define PIN_SWDIO_TMS_CLR() fake_output(0)
#define PIN_SWDIO_TMS_IN() 1U
#define PIN_SWDIO_IN() fake_input()
#define PIN_SWDIO_OUT(v) fake_output((v)&1U)
#define PIN_SWDIO_OUT_ENABLE() fake_enable(1)
#define PIN_SWDIO_OUT_DISABLE() fake_enable(0)
#define PIN_nRESET_IN() 1U
#define PIN_nRESET_OUT(v) ((void)(v))
